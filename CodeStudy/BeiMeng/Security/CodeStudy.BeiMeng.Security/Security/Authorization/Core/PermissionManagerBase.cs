namespace CodeStudy.BeiMeng.Security.Security.Authorization.Core
{
    public abstract class PermissionManagerBase:IPermissionManager
    {
        ...
        //{
        //    var result = _permissionSupportService.IsInApplication(GetUserId());
        //    return result;
        //}
        ...
        //{
        //    return _applicationContext.UserId;
        //}
        ...
        //{
        //    var result = _permissionSupportService.IsInTenant(GetUserId());
        //    return result;
        //}
        /// <summary>
        /// 初始化组件
        ...
        /// 获取应用程序上下文
        /// </summary>
        protected virtual ApplicationSession GetApplicationContext()
        {
