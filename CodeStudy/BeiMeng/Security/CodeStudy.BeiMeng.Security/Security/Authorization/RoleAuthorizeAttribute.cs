using System;
using CodeStudy.BeiMeng.Security.Security.Authorization.Core;
using CodeStudy.BeiMeng.Security.Security.Authorization.Web;

namespace CodeStudy.BeiMeng.Security.Security.Authorization
{
    /// <summary>
    /// 基于角色授权验证
    /// </summary>
