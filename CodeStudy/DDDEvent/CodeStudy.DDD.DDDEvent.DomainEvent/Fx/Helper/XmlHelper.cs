...
namespace DomainEvent.Fx.Helper
{
    ...
    public class XmlHelper
    {
        ...
        /// <returns></returns>
        public static bool IsXmlFileExist(string fileName, bool isFullPath = true)
        {
            if (!isFullPath)
        ...
        /// <returns></returns>
        public static XmlDocument ReadFull(string path)
        {
            var x = new XmlHelper(path);
            return x.Read();
        }
        ...
        {
            return strPath.IndexOf(":", StringComparison.Ordinal) > 0
                ? strPath
